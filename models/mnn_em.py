...
class MNNEM(object):
    def __init__(self, img_input_size, img_conv_layers, txt_input_size, txt_conv_layers, txt_weights, char_cnn_config, combined_conv_layers, learning_rate, loss='binary_crossentropy', metrics=["recall", "precision", "binary_accuracy", "cosine_similarity"]) -> None:
